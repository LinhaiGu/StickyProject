...
public class StickyItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int m = 0, size = parent.getChildCount(); m < size; m++) {
             ...
             * 如果是吸附的view
             */
            if (StickyUtil.isStickyView(view)) {
                ...
                if (view.getTop() > 0 && view.getTop() <= mStickyItemViewHeight) {
                    Log.d("ddd","view.getTop() > 0 && view.getTop() <= mStickyItemViewHeight");
                    ...
                    if (nextStickyView != null && nextStickyView.getTop() <= mStickyItemViewHeight) {
                        Log.d("ddd","nextStickyView != null && nextStickyView.getTop() <= mStickyItemViewHeight");
    ...
    private int getStickyViewPositionOfRecyclerView(int m) {
        Log.d("ddd","position-->"+mLayoutManager.findFirstVisibleItemPosition() +" m-->"+m);
        //findFirstVisibleItemPosition:第一个可见Item的在列表中的位置（position)
        //m：吸附Item View在屏幕内可见的位置
        //position+m=吸附View在列表中的位置
    ...
    private void getStickyViewHolder(RecyclerView recyclerView) {
        ...
        mViewHolder = mAdapter.onCreateViewHolder(recyclerView, StickyUtil.getStickViewType());
